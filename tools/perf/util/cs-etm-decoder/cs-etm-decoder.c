                                            ...
                                            uint32_t *numBytesProcessed)
{
        ...
        return RCTDL_RESP_FATAL_SYS_ERR;
}

dcd_tree_handle_t rctdl_create_dcd_tree(const rctdl_dcd_tree_src_t src_type, const uint32_t deformatterCfgFlags)
{
        (void) src_type;
        (void) deformatterCfgFlags;
        return 0;
}

void rctdl_destroy_dcd_tree(const dcd_tree_handle_t handle)
{
        (void) handle;
}

rctdl_err_t rctdl_dt_set_gen_elem_outfn(const dcd_tree_handle_t handle, FnTraceElemIn pFn, const void *p_context)
{
        (void) handle;
        (void) pFn;
        (void) p_context;
...
rctdl_err_t rctdl_dt_create_etmv4i_pkt_proc(const dcd_tree_handle_t handle, const void *etmv4_cfg, FnEtmv4IPacketDataIn pPktFn, const void *p_context)
{
        (void) handle;
        (void) etmv4_cfg;
        (void) pPktFn;
...
rctdl_err_t rctdl_dt_create_etmv4i_decoder(const dcd_tree_handle_t handle, const void *etmv4_cfg)
{
        (void) handle;
        (void) etmv4_cfg;
        return RCTDL_ERR_FAIL;
...
rctdl_err_t rctdl_dt_attach_etmv4i_pkt_mon(const dcd_tree_handle_t handle, const uint8_t trc_chan_id, FnEtmv4IPktMonDataIn pPktFn, const void *p_context)
{
        (void) handle;
        (void) trc_chan_id;
        (void) pPktFn;
...
rctdl_err_t rctdl_dt_create_etmv3_pkt_proc(const dcd_tree_handle_t handle, const void *etmv3_cfg, FnEtmv3PacketDataIn pPktFn, const void *p_context)
{
        (void) handle;
        (void) etmv3_cfg;
        (void) pPktFn;
...
rctdl_err_t rctdl_dt_attach_etmv3_pkt_mon(const dcd_tree_handle_t handle, const uint8_t trc_chan_id, FnEtmv3PktMonDataIn pPktFn, const void *p_context)
{
        (void) handle;
        (void) trc_chan_id;
        (void) pPktFn;
...
rctdl_err_t rctdl_dt_create_stm_pkt_proc(const dcd_tree_handle_t handle, const void *stm_cfg, FnStmPacketDataIn pPktFn, const void *p_context)
{
        (void) handle;
        (void) stm_cfg;
        (void) pPktFn;
...
rctdl_err_t rctdl_gen_elem_str(const rctdl_generic_trace_elem *p_pkt, char *buffer, const int buffer_size)
{
        (void) p_pkt;
        (void) buffer;
        (void) buffer_size;
...
rctdl_err_t rctdl_pkt_str(const rctdl_trace_protocol_t pkt_protocol, const void *p_pkt, char *buffer, const int buffer_size)
{
        (void) pkt_protocol;
        (void) p_pkt;
        (void) buffer;
...
rctdl_err_t rctdl_dt_add_callback_mem_acc(const dcd_tree_handle_t handle, const rctdl_vaddr_t st_address, const rctdl_vaddr_t en_address, const rctdl_mem_space_acc_t mem_space, Fn_MemAcc_CB p_cb_func, const void *p_context)
{
        (void) handle;
        (void) st_address;
        (void) en_address;
